window.quizQuestions = [
  {
    topic: "Neuroanatomy",
    question: "Which structure is a major output nucleus of the basal ganglia?",
    options: [
      "Caudate nucleus",
      "Putamen",
  ...
  },
  {
    ...
    question: "A corticospinal tract lesion typically produces which clinical pattern below the level of the lesion?",
    options: [
  ...
  {
    topic: "Reflexes",
    question: "Hyperreflexia most strongly suggests damage to which part of the motor system?",
    options: [
      "Lower motor neurone",
